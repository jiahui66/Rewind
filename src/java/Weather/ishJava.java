...
//  Fields making up the MW1-7 elements
    ...
    /*public static void main(String[] args){
        ...
        String inputFile = "/Users/prateek/Dropbox/spring-2015/Independent-Study/2015/010030-99999-2015";
        String outputFile = "/Users/prateek/Dropbox/spring-2015/Independent-Study/output.txt";
        String date = "2015-01-17";
        findWeatherInformation(inputFile, outputFile, date);
    }*/

    //public static void main(String[] args)
    public static void findWeatherInformation(String inputFile, String outputFile, String date){
...
// Process args
        ...
        sInFileName     = inputFile;
        sOutFileName    = outputFile;
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-= Filter out all but a certain station/date =-=-=-=-=-=-=-=-=-=-=-=-=-=
                    ...
                    if ( (! sConcatDate.equals(date)) )           // Whole Day
                    //if ( (! sConcatMonth.equals("2015-01")) )           // Whole month
                    {
                        continue;
                    }
